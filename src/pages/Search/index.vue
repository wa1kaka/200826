    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-show="options.categoryName">{{options.categoryName}}
              <i @click="removeCategroy">x</i>
            </li>
            <li class="with-x" v-show="options.keyword">{{options.keyword}}
                <i @click="removeKeyword">x</i>
            </li>
             <li class="with-x" v-show="options.trademark">{{options.trademark}}
        ...
        <!--selector-->
        <SearchSelector :setTrademake='setTrademake' @addProp='addProp'/>
      ...
      <!-- // order	string	N	排序方式 1: 综合,2: 价格 asc: 升序,desc: 降序 示例: "1:desc" -->
                ...
                <li :class="{active:orderArr[1]==='asc'}" @click="setOrder('2')" >
                  <a href="javascript:">价格↑</a>
                </li>
               <li :class="{active:orderArr[1]==='desc' }" @click="setOrder('2')">
                  <a href="javascript:">价格↓</a>
                </li>
              </ul>
            </div>
